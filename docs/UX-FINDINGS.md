...
| Create round (O3, O4) | Every new round re-searched the course list; Hammer greyed with no reason | "Recent" course quick-pick at top of Select Course; "🔨 Hammer is a 2-player game" hint (#24) |
